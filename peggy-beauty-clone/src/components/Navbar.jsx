          ...
          <>
            ...
            <motion.aside animate={{ x: 0 }} className="fixed right-0 top-0 h-full w-80 bg-white shadow-lg z-50" exit={{ x: '100%' }} initial={{ x: '100%' }} transition={{ duration: 0.28, ease: 'easeOut' }} style={{ zIndex: 99999 }}>
              ...
              <nav className="p-4 flex flex-col gap-2">
                ...
                <div className="p-4">
                <a href={bookingUrl} onClick={closeDrawer} className="block w-full text-center rounded bg-primary py-2" target="_blank" rel="noopener noreferrer">Book Now</a>
              </div>
            </motion.aside>
          </>
        )}
